...
| **3.3** | Готовность к RuStore, подписанный APK | **[Выполнено 100%]** | Подписанный релизный APK (82.25 МБ), адаптивная векторная иконка и заставка Splash, карточка `RUSTORE_CARD.md`, иконка 512×512, скрипт `build_apk.ps1`. |
...
Проект снабжен полным комплектом из **32 автоматизированных xUnit тестов** (`FinAPP.Tests`), покрывающих бизнес-логику, экономику, взаимную синхронизацию магазина и целей, эволюцию питомца, сохранение нерегулярных покупок, аудиофайлы и обработку анимаций:
...
```
Результаты: **32 passed, 0 failed, 0 skipped, duration: 114 ms**.
...
```
Файл: `dist/FinAPP.apk` (82.25 МБ, SHA-256: `BA8E6E30354B8134EAFFE513DB2BD2F23CDA7BA857012F15F6CB1F317A132B48`).
