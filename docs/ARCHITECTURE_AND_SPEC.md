...
| **3.3** | Готовность к RuStore, подписанный APK | ✅ **Реализовано (100%)** | Подписанный релизный APK (82.25 МБ), адаптивная векторная иконка и заставка Splash, карточка `RUSTORE_CARD.md`, иконка 512×512, скрипт `build_apk.ps1`. |
