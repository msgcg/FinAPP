...
conversions = [
    ...
    },
    {
        ...
        "video": "sources/847602321_1789635248081390.mp4",
        "start": 1.6, "duration": 2.6, "fps": 13, "key": "green"
    },
    {
        "name": "finny_baby_proud",
        "video": "sources/70322129_1789635247890053.mp4",
        "start": 1.7, "duration": 2.0, "fps": 12, "key": "white"
    },
    {
        "name": "finny_baby_sad",
        "video": "sources/70322129_1789635247890053.mp4",
        "start": 3.6, "duration": 1.8, "fps": 12, "key": "white"
    },
    ...
    },
    {
        ...
        "start": 2.2, "duration": 2.4, "fps": 12, "key": "green"
    },
    ...
    # 3. Master stage
    {
        ...
        "start": 0.2, "duration": 2.3, "fps": 13, "key": "green"
    },
    {
        "name": "finny_master_wave",
        "video": "sources/633314252_1789636297174330.mp4",
        "start": 0.2, "duration": 2.6, "fps": 14, "key": "green"
    },
    {
        "name": "finny_master_proud",
        "video": "sources/600580980_1789636470277742.mp4",
        "start": 0.2, "duration": 2.4, "fps": 13, "key": "green"
    },
    {
...
# Also copy master animations as base fallbacks (finny_idle.gif, finny_wave.gif, finny_proud.gif, finny_sad.gif)
for act in ["idle", "wave", "proud", "sad"]:
    src_img = os.path.join(out_img_dir, f"finny_master_{act}.gif")
